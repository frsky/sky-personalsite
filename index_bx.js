...
?>
    ...
    <head>
        ...
        <script type="text/javascript">
            WebFontConfig = {
                google: {
                    families: ['Lato:400,700,300:latin', 'Open+Sans:300,400,600,700:latin']
                }
            };
            (function() {
        ...
        <style>
            ...
            body {
                background: url(bg.jpg) center center no-repeat fixed #222;
                -webkit-background-size: cover;
                -moz-background-size: cover;
                -o-background-size: cover;
                background-size: cover;
                font-family: 'Lato', 'Open Sans', 'Lucida Grande', Helvetica, Arial
            }
            ...
            .topribbon {
                ...
                border: 0;
                height: 57px;
                font-family: 'Lato', 'Open Sans', Lucida Grande, Helvetica;
                font-size: 10pt;
                text-align: center
            }
            ...
            .bodyprose,
            .ui-widget-content {
                font-family: 'Lato', 'Open Sans', Lucida Grande, Helvetica, sans-serif
            }
            ...
            .cardlink {
                -moz-box-shadow: inset 0 1px 3px 0 #d1d1d1;
                -webkit-box-shadow: inset 0 1px 3px 0 #d1d1d1;
                box-shadow: inset 0 1px 3px 0 #d1d1d1;
                background: -webkit-gradient(linear, left top, left bottom, color-stop(.05, #e6e6e6), color-stop(1, #d1cdd1));
            ...
            .front-ff {
                border: 0;
                background: url(ff.png) left top no-repeat #222!important;
                color: #fff!important
            }

            .back-ff {
                border: 0;
                background: url(f2.png) left top no-repeat #DDD!important;
                color: #000!important
            }

            .front-sp {
                border: 0;
                background: url(sp.png) left top no-repeat #222!important;
                color: #fff!important
            }
            ...
            .front-gt {
                border: 0;
                background: url(gt.png) left top no-repeat #222!important;
                color: #fff!important
            }
            ...
            .front-am {
                border: 0;
                background: url(am.png) left top no-repeat #222!important;
                color: #fff!important
            }
            ...
            .front-hd {
                border: 0;
                background: url(hd.png) left top no-repeat #222!important;
                color: #fff!important
            }
            ...
            .front-tw {
                border: 0;
                background: url(tw.png) left top no-repeat #222!important;
                color: #fff!important
            }
            ...
            .front-io {
                border: 0;
                background: url(io.png) left top no-repeat #222!important;
                color: #fff!important
            }
            ...
            .front-id {
                border: 0;
                background: url(id.png) left top no-repeat #222!important;
                color: #fff!important
            }
            ...
            .front-tj {
                border: 0;
                background: url(tj.png) left top no-repeat #222!important;
                color: #fff!important
            }
            ...
            .front-ww {
                border: 0;
                background: url(ww.png) left top no-repeat #595a7b!important;
                color: #fff!important
            }
            ...
            .front-gv {
                border: 0;
                background: url(gv.png) left top no-repeat #222!important;
                color: #fff!important
            }
            ...
            .front-hz {
                border: 0;
                background: url(hz.png) left top no-repeat #222!important;
                color: #fff!important
            }
            ...
            .front-ub {
                border: 0;
                background: url(ub.png) left top no-repeat #222!important;
                color: #fff!important
            }
            ...
            .front-ia {
                border: 0;
                background: url(ia.png) left top no-repeat #222!important;
                color: #fff!important
            }
            ...
            .front-kb {
                border: 0;
                background: url(kb.png) left top no-repeat #222!important;
                color: #fff!important
            }
            ...
            #drop-menu li a {
                display: block;
                width: 275px;
                background: url(ibutton.png) left top no-repeat;
                font-size: 12pt;
                padding: 10px 0;
                height: 57px display: inline;
                text-align: center
            }
    ...
    <body>
        ...
        <div id="itis" class="bodyprose">
            <div id="itissub" class="bodyprose"><br>
                <p style="font-size:14px;">I'm an engineer, inventor, start-upper, and a bunch of other things. These are my major jobs and projects, on cards, spread around this page. <br><span class="medstrong">You can drag them around, and hit <img src="flipw.png" width="18" align="absbottom"> to flip the card for more info...</span></p>
                <div
                    style="clear:both;">
                    ...
                    <div class="divact4">
                        <a href="http://www.linkedin.com/pub/frank-sikernitsky/0/148/8aa/" target="_blank" class="golinkedin"><img src="linkin.png" border=0></a><br><span class='titleminor'>profile</span><br>the conventional view</div>
            </div>
        </div>
        </div>
        </div>
        ...
        <script src="jquery/js/jquery.flippy.min.js" async="true"></script>
        <script>
            $(function() {
                $("#drag-io").draggable({
                    opacity: 0.35
            ...
            $("#drag-io").on("dragstop", function() {
                ga('send', 'event', 'carddrag', 'IntranetOffice');
            });
            $("#drag-sp").on("dragstop", function() {
                ga('send', 'event', 'carddrag', 'Author');
            });
            $("#drag-gv").on("dragstop", function() {
                ga('send', 'event', 'carddrag', 'BoxQueue');
            });
            $("#drag-tw").on("dragstop", function() {
                ga('send', 'event', 'carddrag', 'Window');
            });
            $("#drag-id").on("dragstop", function() {
                ga('send', 'event', 'carddrag', 'IdeaDev');
            });
            $("#drag-gt").on("dragstop", function() {
                ga('send', 'event', 'carddrag', 'rootcloud');
            });
            $("#drag-tj").on("dragstop", function() {
                ga('send', 'event', 'carddrag', 'TrincollJournal');
            });
            // $( "#drag-ww" ).draggable({ drag: ga('send', 'event', 'carddrag', 'Distechnical'), opacity: 0.35 });
            $("#drag-hd").on("dragstop", function() {
                ga('send', 'event', 'carddrag', 'HeresDinner');
            });
            $("#drag-ff").on("dragstop", function() {
                ga('send', 'event', 'carddrag', 'FitFiler');
            });
            $("#drag-am").on("dragstop", function() {
                ga('send', 'event', 'carddrag', 'AttendeeManagement');
            });
            $("#drag-hz").on("dragstop", function() {
                ga('send', 'event', 'carddrag', 'HobokenZoo');
            });
            $("#drag-ub").on("dragstop", function() {
                ga('send', 'event', 'carddrag', 'fuxnux');
            });
            $("#drag-ia").on("dragstop", function() {
                ga('send', 'event', 'carddrag', 'iasqu');
            });
            $("#drag-kb").on("dragstop", function() {
                ga('send', 'event', 'carddrag', 'Klipbrd');
            });
            ...
            $(function() {
                $(document).on('click', '#goback-ff', function() {
                    ...
                    $("#drag-ff").flippy({
                        ...
                        onStart: function() {
                            $("#drag-ff").removeClass("dragshadow");
                            $("#drag-ff").removeClass("front-ff");
                        },
                        onFinish: function() {
                            $("#drag-ff").addClass("back-ff");
                            $("#drag-ff").addClass("dragshadow");
                        }
                    });
                });
            });
            ...
            $(function() {
                $(document).on('click', '#gofront-ff', function() {
                    $("#drag-ff").flippy({
                        ...
                        light: 0,
                        color_target: '#336633',
                        content: '<span id=goback-ff><img src=flip.png  hspace=4 vspace=4></span>',
                        onStart: function() {
                            $("#drag-ff").removeClass("dragshadow");
                            $("#drag-ff").removeClass("back-ff");
                        },
                        onFinish: function() {
                            $("#drag-ff").addClass("front-ff");
                            $("#drag-ff").addClass("dragshadow");
                        }
                    });
                });
            ...
            $(function() {
                $(document).on('click', '#goback-id', function() {
                    ...
                    $("#drag-id").flippy({
                        ...
                        onStart: function() {
                            $("#drag-id").removeClass("dragshadow");
                            $("#drag-id").removeClass("front-id");
                        },
                        onFinish: function() {
                            $("#drag-id").addClass("back-id");
                            $("#drag-id").addClass("dragshadow");
                        }
                    });
                });
            });
            ...
            $(function() {
                $(document).on('click', '#gofront-id', function() {
                    $("#drag-id").flippy({
                        ...
                        light: 0,
                        color_target: '#6666cc',
                        content: '<span id=goback-id><img src=flip.png  hspace=4 vspace=4></span>',
                        onStart: function() {
                            $("#drag-id").removeClass("dragshadow");
                            $("#drag-id").removeClass("back-id");
                        },
                        onFinish: function() {
                            $("#drag-id").addClass("front-id");
                            $("#drag-id").addClass("dragshadow");
                        }
                    });
                });
            ...
            $(function() {
                $(document).on('click', '#goback-hd', function() {
                    ...
                    $("#drag-hd").flippy({
                        ...
                        onStart: function() {
                            $("#drag-hd").removeClass("dragshadow");
                            $("#drag-hd").removeClass("front-hd");
                        },
                        onFinish: function() {
                            $("#drag-hd").addClass("back-hd");
                            $("#drag-hd").addClass("dragshadow");
                        }
                    });
                });
            });
            ...
            $(function() {
                $(document).on('click', '#gofront-hd', function() {
                    $("#drag-hd").flippy({
                        direction: 'LEFT',
                        light: 0,
                        content: '<span id=goback-hd><img src=flip.png  hspace=4 vspace=4></span>',
                        onStart: function() {
                            $("#drag-hd").removeClass("dragshadow");
                            $("#drag-hd").removeClass("back-hd");
                        },
                        onFinish: function() {
                            $("#drag-hd").addClass("front-hd");
                            $("#drag-hd").addClass("dragshadow");
                        }
                    });
                });
            ...
            $(function() {
                $(document).on('click', '#goback-sp', function() {
                    ...
                    $("#drag-sp").flippy({
                        ...
                        onStart: function() {
                            $("#drag-sp").removeClass("dragshadow");
                            $("#drag-sp").removeClass("front-sp");
                        },
                        onFinish: function() {
                            $("#drag-sp").addClass("back-sp");
                            $("#drag-sp").addClass("dragshadow");
                        }
                    });
                });
            });
            $(function() {
                $(document).on('click', '#gofront-sp', function() {
                    $("#drag-sp").flippy({
                        direction: 'LEFT',
                        light: 0,
                        content: '<span id=goback-sp><img src=flip.png  hspace=4 vspace=4></span>',
                        onStart: function() {
                            $("#drag-sp").removeClass("dragshadow");
                            $("#drag-sp").removeClass("back-sp");
                        },
                        onFinish: function() {
                            $("#drag-sp").addClass("front-sp");
                            $("#drag-sp").addClass("dragshadow");
                        }
                    });
                });
            ...
            $(function() {
                $(document).on('click', '#goback-tw', function() {
                    ...
                    $("#drag-tw").flippy({
                        ...
                        onStart: function() {
                            $("#drag-tw").removeClass("dragshadow");
                            $("#drag-tw").removeClass("front-tw");
                        },
                        onFinish: function() {
                            $("#drag-tw").addClass("back-tw");
                            $("#drag-tw").addClass("dragshadow");
                        }
                    });
                });
            });
            ...
            $(function() {
                $(document).on('click', '#gofront-tw', function() {
                    $("#drag-tw").flippy({
                        ...
                        light: 0,
                        color_target: '#3366cc',
                        content: '<span id=goback-tw><img src=flip.png  hspace=4 vspace=4></span>',
                        onStart: function() {
                            $("#drag-tw").removeClass("dragshadow");
                            $("#drag-tw").removeClass("back-tw");
                        },
                        onFinish: function() {
                            $("#drag-tw").addClass("front-tw");
                            $("#drag-tw").addClass("dragshadow");
                        }
                    });
                });
            ...
            $(function() {
                $(document).on('click', '#goback-io', function() {
                    ...
                    $("#drag-io").flippy({
                        ...
                        onStart: function() {
                            $("#drag-io").removeClass("dragshadow");
                            $("#drag-io").removeClass("front-io");
                        },
                        onFinish: function() {
                            $("#drag-io").addClass("back-io");
                            $("#drag-io").addClass("dragshadow");
                        }
                    });
                });
            });
            ...
            $(function() {
                $(document).on('click', '#gofront-io', function() {
                    $("#drag-io").flippy({
                        ...
                        light: 0,
                        color_target: '#d32700',
                        content: '<span id=goback-io><img src=flip.png  hspace=4 vspace=4></span>',
                        onStart: function() {
                            $("#drag-io").removeClass("dragshadow");
                            $("#drag-io").removeClass("back-io");
                        },
                        onFinish: function() {
                            $("#drag-io").addClass("front-io");
                            $("#drag-io").addClass("dragshadow");
                        }
                    });
                });
            ...
            $(function() {
                $(document).on('click', '#goback-hz', function() {
                    ...
                    $("#drag-hz").flippy({
                        ...
                        onStart: function() {
                            $("#drag-hz").removeClass("dragshadow");
                            $("#drag-hz").removeClass("front-hz");
                        },
                        onFinish: function() {
                            $("#drag-hz").addClass("back-hz");
                            $("#drag-hz").addClass("dragshadow");
                        }
                    });
                });
            });
            ...
            $(function() {
                $(document).on('click', '#gofront-hz', function() {
                    $("#drag-hz").flippy({
                        direction: 'LEFT',
                        light: 0,
                        content: '<span id=goback-hz><img src=flip.png  hspace=4 vspace=4></span>',
                        onStart: function() {
                            $("#drag-hz").removeClass("dragshadow");
                            $("#drag-hz").removeClass("back-hz");
                        },
                        onFinish: function() {
                            $("#drag-hz").addClass("front-hz");
                            $("#drag-hz").addClass("dragshadow");
                        }
                    });
                });
            ...
            $(function() {
                $(document).on('click', '#goback-gv', function() {
                    ...
                    $("#drag-gv").flippy({
                        ...
                        onStart: function() {
                            $("#drag-gv").removeClass("dragshadow");
                            $("#drag-gv").removeClass("front-gv");
                        },
                        onFinish: function() {
                            $("#drag-gv").addClass("back-gv");
                            $("#drag-gv").addClass("dragshadow");
                        }
                    });
                });
            });
            $(function() {
                $(document).on('click', '#gofront-gv', function() {
                    $("#drag-gv").flippy({
                        direction: 'LEFT',
                        light: 0,
                        content: '<span id=goback-gv><img src=flip.png  hspace=4 vspace=4></span>',
                        onStart: function() {
                            $("#drag-gv").removeClass("dragshadow");
                            $("#drag-gv").removeClass("back-gv");
                        },
                        onFinish: function() {
                            $("#drag-gv").addClass("front-gv");
                            $("#drag-gv").addClass("dragshadow");
                        }
                    });
                });
            ...
            $(function() {
                $(document).on('click', '#goback-ub', function() {
                    ...
                    $("#drag-ub").flippy({
                        ...
                        onStart: function() {
                            $("#drag-ub").removeClass("dragshadow");
                            $("#drag-ub").removeClass("front-ub");
                        },
                        onFinish: function() {
                            $("#drag-ub").addClass("back-ub");
                            $("#drag-ub").addClass("dragshadow");
                        }
                    });
                });
            });
            ...
            $(function() {
                $(document).on('click', '#gofront-ub', function() {
                    $("#drag-ub").flippy({
                        direction: 'LEFT',
                        light: 0,
                        content: '<span id=goback-ub><img src=flipx.png  hspace=4 vspace=4></span>',
                        onStart: function() {
                            $("#drag-ub").removeClass("dragshadow");
                            $("#drag-ub").removeClass("back-ub");
                        },
                        onFinish: function() {
                            $("#drag-ub").addClass("front-ub");
                            $("#drag-ub").addClass("dragshadow");
                        }
                    });
                });
            ...
            $(function() {
                $(document).on('click', '#goback-ww', function() {
                    ...
                    $("#drag-ww").flippy({
                        ...
                        onStart: function() {
                            $("#drag-ww").removeClass("dragshadow");
                            $("#drag-ww").removeClass("front-ww");
                        },
                        onFinish: function() {
                            $("#drag-ww").addClass("back-ww");
                            $("#drag-ww").addClass("dragshadow");
                        }
                    });
                });
            });
            ...
            $(function() {
                $(document).on('click', '#gofront-ww', function() {
                    $("#drag-ww").flippy({
                        ...
                        light: 0,
                        color_target: '#595a7b',
                        content: '<span id=goback-ww><img src=flip.png  hspace=4 vspace=4></span>',
                        onStart: function() {
                            $("#drag-ww").removeClass("dragshadow");
                            $("#drag-ww").removeClass("back-ww");
                        },
                        onFinish: function() {
                            $("#drag-ww").addClass("front-ww");
                            $("#drag-ww").addClass("dragshadow");
                        }
                    });
                });
            ...
            $(function() {
                $(document).on('click', '#goback-gt', function() {
                    ...
                    $("#drag-gt").flippy({
                        ...
                        onStart: function() {
                            $("#drag-gt").removeClass("dragshadow");
                            $("#drag-gt").removeClass("front-gt");
                        },
                        onFinish: function() {
                            $("#drag-gt").addClass("back-gt");
                            $("#drag-gt").addClass("dragshadow");
                        }
                    });
                });
            });
            ...
            $(function() {
                $(document).on('click', '#gofront-gt', function() {
                    $("#drag-gt").flippy({
                        direction: 'LEFT',
                        light: 0,
                        content: '<span id=goback-gt><img src=flip.png  hspace=4 vspace=4></span>',
                        onStart: function() {
                            $("#drag-gt").removeClass("dragshadow");
                            $("#drag-gt").removeClass("back-gt");
                        },
                        onFinish: function() {
                            $("#drag-gt").addClass("front-gt");
                            $("#drag-gt").addClass("dragshadow");
                        }
                    });
                });
            ...
            $(function() {
                $(document).on('click', '#goback-am', function() {
                    ...
                    $("#drag-am").flippy({
                        ...
                        onStart: function() {
                            $("#drag-am").removeClass("dragshadow");
                            $("#drag-am").removeClass("front-am");
                        },
                        onFinish: function() {
                            $("#drag-am").addClass("back-am");
                            $("#drag-am").addClass("dragshadow");
                        }
                    });
                });
            });
            ...
            $(function() {
                $(document).on('click', '#gofront-am', function() {
                    $("#drag-am").flippy({
                        direction: 'LEFT',
                        light: 0,
                        content: '<span id=goback-am><img src=flip.png  hspace=4 vspace=4></span>',
                        onStart: function() {
                            $("#drag-am").removeClass("dragshadow");
                            $("#drag-am").removeClass("back-am");
                        },
                        onFinish: function() {
                            $("#drag-am").addClass("front-am");
                            $("#drag-am").addClass("dragshadow");
                        }
                    });
                });
            ...
            $(function() {
                $(document).on('click', '#goback-tj', function() {
                    ...
                    $("#drag-tj").flippy({
                        ...
                        onStart: function() {
                            $("#drag-tj").removeClass("dragshadow");
                            $("#drag-tj").removeClass("front-tj");
                        },
                        onFinish: function() {
                            $("#drag-tj").addClass("back-tj");
                            $("#drag-tj").addClass("dragshadow");
                        }
                    });
                });
            });
            ...
            $(function() {
                $(document).on('click', '#gofront-tj', function() {
                    $("#drag-tj").flippy({
                        direction: 'LEFT',
                        light: 0,
                        content: '<span id=goback-tj><img src=flip.png  hspace=4 vspace=4></span>',
                        onStart: function() {
                            $("#drag-tj").removeClass("dragshadow");
                            $("#drag-tj").removeClass("back-tj");
                        },
                        onFinish: function() {
                            $("#drag-tj").addClass("front-tj");
                            $("#drag-tj").addClass("dragshadow");
                        }
                    });
                });
            ...
            $(function() {
                $(document).on('click', '#goback-kb', function() {
                    ...
                    $("#drag-kb").flippy({
                        ...
                        onFinish: function() {
                            $("#drag-kb").addClass("back-kb");
                            $("#drag-kb").addClass("dragshadow");
                        }
                    });
                });
            });
            ...
            $(function() {
                $(document).on('click', '#gofront-kb', function() {
                    $("#drag-kb").flippy({
                        direction: 'LEFT',
                        light: 0,
                        content: '<span id=goback-kb><img src=flip.png  hspace=4 vspace=4></span>',
                        onStart: function() {
                            $("#drag-kb").removeClass("dragshadow");
                            $("#drag-kb").removeClass("back-kb");
                        },
                        onFinish: function() {
                            $("#drag-kb").addClass("front-kb");
                            $("#drag-kb").addClass("dragshadow");
                        }
                    });
                });
            ...
            $(function() {
                $(document).on('click', '#goback-ia', function() {
                    ...
                    $("#drag-ia").flippy({
                        ...
                        onStart: function() {
                            $("#drag-ia").removeClass("dragshadow");
                            $("#drag-ia").removeClass("front-ia");
                        },
                        onFinish: function() {
                            $("#drag-ia").addClass("back-ia");
                            $("#drag-ia").addClass("dragshadow");
                        }
                    });
                });
            });
            ...
            $(function() {
                $(document).on('click', '#gofront-ia', function() {
                    $("#drag-ia").flippy({
                        direction: 'LEFT',
                        light: 0,
                        content: '<span id=goback-ia><img src=flip.png  hspace=4 vspace=4></span>',
                        onStart: function() {
                            $("#drag-ia").removeClass("dragshadow");
                            $("#drag-ia").removeClass("back-ia");
                        },
                        onFinish: function() {
                            $("#drag-ia").addClass("front-ia");
                            $("#drag-ia").addClass("dragshadow");
                        }
                    });
                });
