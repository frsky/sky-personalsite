...
#drag-hd { width: 220px; height: 220px; background-size:220px !important; position:absolute !important; top:236px; left:410px; }

#drag-tw { width: 220px; height: 220px;  background-size:220px !important; position:absolute !important; top:91px; left:312px; }
		
#drag-ff { width: 220px; height: 220px;  background-size:220px !important; position:absolute !important; top:169px; left:330px; }

#drag-sp { width: 220px; height: 220px;  background-size:220px !important; position:absolute !important; top:65px; left:12px; }

#drag-io { width: 220px; height: 220px;  background-size:220px !important; position:absolute !important; top:325px; left:205px;}
		
#drag-id { width: 220px; height: 220px;  background-size:220px !important; position:absolute !important; top:107px; left:115px;}
		
#drag-tj { width: 220px; height: 220px;  background-size:220px !important; position:absolute !important; top:282px; left:52px;}
		
#drag-gv { width: 220px; height: 220px;  background-size:220px !important; position:absolute !important; top:352px; left:33px;}
...
#drag-kb { width: 220px; height: 220px;  background-size:220px !important; position:absolute !important; top:146px; left:285px;}

#drag-ia { width: 220px; height: 220px;  background-size:220px !important; position:absolute !important; top:259px; left:295px;}
...
<script>
	...
	$(function() {
     ...
     $( "#drag-gt" ).draggable({ drag: ga('send', 'event', 'carddrag', 'IntranetOffice'), opacity: 0.35 });
     ...
     $( "#drag-c2" ).draggable({ drag: ga('send', 'event', 'carddrag', 'CloudTwo'), opacity: 0.35 });
     $( "#drag-ub" ).draggable({ drag: ga('send', 'event', 'carddrag', 'Genesis'), opacity: 0.35 });
...
$(document).on('click', '#lineme', function () {
   ...
   $("#drag-tw").animate({top: 75, left: 100}, { duration: 400, queue: false }).css("z-index","2");
   $("#drag-io").animate({top: 75, left: 180}, { duration: 400, queue: false }).css("z-index","3");
   $("#drag-id").animate({top: 75, left: 260}, { duration: 400, queue: false }).css("z-index","4");
   $("#drag-am").animate({top: 75, left: 340}, { duration: 400, queue: false }).css("z-index","5");
   $("#drag-hd").animate({top: 75, left: 420}, { duration: 400, queue: false }).css("z-index","6");
   ...
   $("#drag-sp").animate({top: 75, left:20 }, { duration: 400, queue: false }).css("z-index","0");
   $("#drag-ff").animate({top: 260, left:440 }, { duration: 400, queue: false }).css("z-index","12");
   $("#drag-ub").animate({top: 260, left:360 }, { duration: 400, queue: false }).css("z-index","11");
   $("#drag-kb").animate({top: 260, left:440 }, { duration: 400, queue: false }).css("z-index","13");
   $("#drag-ia").animate({top: 260, left:360 }, { duration: 400, queue: false }).css("z-index","14");
...
$(function() {  
		$(document).on('click', '#goback-c2', function(){	
				ga('send', 'event', 'cardflip', 'CloudTwo');	
				$("#drag-c2").flippy({ direction:'LEFT', light:0,
					content:'<span id=gofront-c2><img src=flipx.png hspace=4 vspace=4></span><span class=ttlspc>Cloud Two</span><p class=prose><strong>Lead Researcher</strong><br>Cloud-two is my lab environment for designing and testing alternative cloud implementations, as well as customer hosting.</p> <p class=prose><strong>Dates</strong> 2010 - Current<br><strong>Status</strong> Private Client Production<br><a href=http://www.cloud-two.com class=cardlink target=_blank>www.cloud-two.com</a> ',
...
$(function() {  
		$(document).on('click', '#goback-ub', function(){	
				ga('send', 'event', 'cardflip', 'Genesis');	
...
$(function() {  
		$(document).on('click', '#goback-gt', function(){	
				ga('send', 'event', 'cardflip', 'GorillaTeach');	
...
$(function() {  
		$(document).on('click', '#goback-ia', function(){	
				...
				$("#drag-ia").flippy({ direction:'LEFT', light:0,
					content:'<span id=gofront-ia><img src=flipx.png hspace=4 vspace=4></span><span class=ttlspc>iasqu</span><p class=prose><strong>Advisor</strong><br>iasqu is one of the first true social polling platforms, providing a way to ask meaningful questions in a variety of social media venues. Available as an app, site, service and API.</span><p class=prose><strong>Dates</strong> 2014<br><strong>Status</strong> Active<br><a href=http://www.iasqu.com class=cardlink target=_blank>www.iasqu.com</a>',
